...
proc create_root_design { parentCell } {
  ...
  set anodes [ create_bd_port -dir O -type data anodes ]
  set data [ create_bd_port -dir O -type data data ]
  ...
  # Create instance: SEG7_0, and set properties
  set SEG7_0 [ create_bd_cell -type ip -vlnv SMBEDU:user:SEG7:1.0 SEG7_0 ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M06_AXI [get_bd_intf_pins SEG7_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M06_AXI]
  ...
  # Create port connections
  connect_bd_net -net SEG7_0_S_AXI_Data [get_bd_ports seg] [get_bd_pins SEG7_0/S_AXI_Data]
  connect_bd_net -net SEG7_0_S_AXI_anodes [get_bd_ports an] [get_bd_pins SEG7_0/S_AXI_anodes]
  connect_bd_net -net axi_timer_0_interrupt [get_bd_pins axi_timer_0/interrupt] [get_bd_pins microblaze_0_xlconcat/In0] [get_bd_pins microblaze_0_xlconcat/In1]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins SEG7_0/s00_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk]
